...
CREATE DATABASE  IF NOT EXISTS `evento_automatico` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `evento_automatico`;
-- MySQL dump 10.13  Distrib 5.5.50, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: evento_automatico
-- ------------------------------------------------------
...
-- Dump completed on 2017-08-21 14:27:46